 ...
 * @author david
 */
public class PrecioHistórico extends javax.swing.JFrame {

    /**
     * Creates new form PrecioHistórico
     */
    public PrecioHistórico() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrecioHistórico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrecioHistórico().setVisible(true);
            }
        });
    }
