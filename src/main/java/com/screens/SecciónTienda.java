 ...
 * @author Ariel
 */
public class SecciónTienda extends javax.swing.JFrame {

    /**
     * Creates new form SecciónTienda
     */
    public SecciónTienda() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ÁreaLaboral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SecciónTienda().setVisible(true);
        });
    }
